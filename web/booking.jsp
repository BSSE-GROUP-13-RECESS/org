...
<%@taglib uri="https://org.com" prefix="booking"%>
  <c:if test="${sessionScope.userType.equals('patient')}">
    ...
    <div hidden><booking:select table="count(*) as count from booking" displayFormat="table" where="patient_id=${sessionScope.patientId}"/></div>
    <br/>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                <c:set var="bookCount" scope="page" value="${requestScope.data.size()}"/>

                <c:if test="${pageScope.bookCount==0}">
